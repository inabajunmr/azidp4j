...
/** Copy from org.springframework.security.oauth2.server.resource.web.DefaultBearerTokenResolver */
public class OIDCConformanceTestBearerTokenResolver implements BearerTokenResolver {
    ...
    private boolean isParameterTokenSupportedForRequest(final HttpServletRequest request) {
        // allow 'application/x-www-form-urlencoded;charset=UTF-8' for conformance test
        var contentType =
